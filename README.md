...
## Example:
A basic working code for both types of update implementation. 
```javascript
...
```
[Another example project(.tsx)](https://github.com/SudoPlz/sp-react-native-in-app-updates/blob/v1/Example/App.tsx#L38)
<br>
<br>
